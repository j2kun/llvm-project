// RUN: mlir-opt -convert-vector-to-llvm="enable-arm-sve" -convert-arith-to-llvm -convert-func-to-llvm -reconcile-unrealized-casts -split-input-file %s | FileCheck %s
